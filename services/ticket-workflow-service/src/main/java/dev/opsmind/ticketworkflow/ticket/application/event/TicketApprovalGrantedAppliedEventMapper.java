...
/** SPEC-TW-015 event-contract: maps {@link TicketApprovalGrantedApplied} to a {@code ticket.approval-granted-applied.v1} Outbox entry. */
@Component
public class TicketApprovalGrantedAppliedEventMapper {

    private static final String AGGREGATE_TYPE = "Ticket";
    private static final String DATA_CLASSIFICATION = "INTERNAL";

    public OutboxEventEntry map(TicketApprovalGrantedApplied event, SupportQueueId supportQueueId, String traceId, String correlationId, String causationId) {
