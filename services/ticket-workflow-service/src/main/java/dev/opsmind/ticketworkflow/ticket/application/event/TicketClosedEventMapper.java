...
/** SPEC-TW-011 event-contract §2: maps {@link TicketClosed} to a {@code ticket.closed.v1} Outbox entry. */
@Component
public class TicketClosedEventMapper {

    private static final String AGGREGATE_TYPE = "Ticket";
    private static final String DATA_CLASSIFICATION = "INTERNAL";

    public OutboxEventEntry map(TicketClosed event, SupportQueueId supportQueueId, String traceId, String correlationId, String causationId) {
