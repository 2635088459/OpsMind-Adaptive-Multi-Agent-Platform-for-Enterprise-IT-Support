...
/** SPEC-TW-006 §17/§23: Support without the internal scope reads no internal rows and triggers no required Audit. */
@Tag("unit")
class SupportPublicTimelineVisibilityTest {

    private static final Instant NOW = Instant.parse("2026-07-25T20:00:00Z");
    private static final UUID TICKET_ID = UUID.randomUUID();

    @Test
    void supportPublicQueryShouldPassIncludeInternalFalseAndSkipAudit() {
