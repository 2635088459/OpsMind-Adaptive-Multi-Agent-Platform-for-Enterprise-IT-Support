...
public class SecurityConfig {
    ...
    /** SPEC-SC-006/008/009: domain 10's own frontend calls this service's public API directly from a real browser origin. Empty/deny by default — see PortalCorsProperties's own javadoc. */
    @Bean
    public CorsConfigurationSource corsConfigurationSource(PortalCorsProperties properties) {
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "Content-Type", "Idempotency-Key", "X-Correlation-Id", "traceparent"));
