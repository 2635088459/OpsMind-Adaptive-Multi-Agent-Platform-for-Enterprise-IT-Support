...
实现 evaluator failure、approval expiry worker、poison decision、outbox replay 和 fail-closed degraded mode。
...
|---|---|---|---|
| 1 | `SPEC-PG-032` | Policy Evaluator Failure 与降级模式 | 10-failure-handling, 12-observability |
| 2 | `SPEC-PG-033` | Approval Expiry、Poison 与 Recovery Workers | 10-failure-handling, 08-transaction-and-outbox |
| 3 | `SPEC-PG-034` | Processed Event Replay 与 Backfill | 09-concurrency-and-idempotency, 10-failure-handling |
