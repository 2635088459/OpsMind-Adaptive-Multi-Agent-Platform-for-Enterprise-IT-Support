...
实现 RBAC/ABAC、职责分离、approval authenticity、MFA/step-up marker 和 override guard。
...
|---|---|---|---|
| 1 | `SPEC-PG-014` | RBAC/ABAC 授权 | 11-security, 02-business-invariants |
| 2 | `SPEC-PG-015` | 职责分离检查 | 11-security, 02-business-invariants |
| 3 | `SPEC-PG-016` | Approval Authenticity 与 Step-Up | 11-security, 05-api-contracts |
| 4 | `SPEC-PG-017` | Sensitive Input 与 Audit Redaction | 11-security, 12-observability |
