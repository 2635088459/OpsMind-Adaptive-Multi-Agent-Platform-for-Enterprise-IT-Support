...
补齐 metrics/logs/traces、governance audit query、audit integrity 和 compliance reporting。
...
|---|---|---|---|
| 1 | `SPEC-PG-029` | Governance Metrics、Logs 与 Traces | 12-observability |
| 2 | `SPEC-PG-030` | Governance Audit Query API | 12-observability, 05-api-contracts, 07-data-model |
| 3 | `SPEC-PG-031` | Audit Integrity 与 Compliance Reporting | 11-security, 12-observability |
