...
实现高风险 override、SLA/ticket exception、admin repair approval 和范围化撤销。
...
|---|---|---|---|
| 1 | `SPEC-PG-022` | High Risk Override 生命周期 | 03-state-machine, 04-use-cases, 11-security |
| 2 | `SPEC-PG-023` | Ticket SLA/Exception Approval | 04-use-cases, 06-event-contracts |
| 3 | `SPEC-PG-024` | Admin Repair 与 Replay Approval | 02-business-invariants, 11-security, 10-failure-handling |
