...
实现 Policy/Rule/Version 模型、decision API、rule evaluator、risk mapping 和 constraints 输出。
...
|---|---|---|---|
| 1 | `SPEC-PG-004` | Policy 与 Rule 领域模型 | 01-domain-model, 02-business-invariants |
| 2 | `SPEC-PG-005` | Policy Decision 聚合 | 01-domain-model, 03-state-machine, 07-data-model |
| 3 | `SPEC-PG-006` | Decision Evaluate API | 05-api-contracts, 09-concurrency-and-idempotency |
| 4 | `SPEC-PG-007` | Rule Evaluator 与 Risk Mapping | 04-use-cases, 10-failure-handling |
| 5 | `SPEC-PG-008` | Decision Constraints 与 Policy Version Snapshot | 02-business-invariants, 09-concurrency-and-idempotency |
