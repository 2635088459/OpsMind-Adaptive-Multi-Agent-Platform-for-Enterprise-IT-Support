...
实现 ticket/cycle/workflow 范围内的短期上下文存储、merge、查询和归档。
...
|---|---|---|---|
| 1 | `SPEC-MK-004` | Working Memory 聚合 | 01-domain-model, 02-business-invariants |
| 2 | `SPEC-MK-005` | Working Memory 更新与 merge API | 04-use-cases, 05-api-contracts, 09-concurrency-and-idempotency |
| 3 | `SPEC-MK-006` | Working Memory 查询与归档 | 05-api-contracts, 03-state-machine |
