...
实现 ACL、classification、PII/secret redaction、prompt injection 和 graph traversal guard。
...
|---|---|---|---|
| 1 | `SPEC-MK-025` | Retrieval access control 与 ACL | 11-security, 02-business-invariants |
| 2 | `SPEC-MK-026` | PII/Secret redaction policy | 11-security |
| 3 | `SPEC-MK-027` | Prompt injection 与 graph traversal guard | 11-security, 04-use-cases |
