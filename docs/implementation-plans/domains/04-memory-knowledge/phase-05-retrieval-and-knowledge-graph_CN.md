# Phase 05 — Retrieval 与 Knowledge Graph
...
实现 hybrid retrieval、graph node/edge、bounded graph expansion、provenance 和 degraded retrieval。
...
| 3 | `SPEC-MK-019` | Bounded Graph expansion、rerank 与 provenance | 04-use-cases, 05-api-contracts, 11-security |
| 4 | `SPEC-MK-020` | Retrieval log 与 degraded mode | 10-failure-handling, 12-observability |
