...
从 02/03 事实事件抽取长期记忆候选，并完成 redaction、validation、dedup、conflict 和 review。
...
|---|---|---|---|
| 1 | `SPEC-MK-010` | 消费 Ticket memory source events | 06-event-contracts, 09-concurrency-and-idempotency |
| 2 | `SPEC-MK-011` | 抽取与脱敏 Memory Candidate | 01-domain-model, 04-use-cases, 11-security |
| 3 | `SPEC-MK-012` | Candidate validation、dedup 与 conflict | 02-business-invariants, 03-state-machine |
