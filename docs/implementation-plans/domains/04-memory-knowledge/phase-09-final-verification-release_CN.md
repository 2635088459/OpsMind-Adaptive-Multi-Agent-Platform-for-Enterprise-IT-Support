...
完成 contract/e2e harness、coverage audit 和 release readiness。
...
|---|---|---|---|
| 1 | `SPEC-MK-031` | Contract 与 E2E test harness | 14-testing-strategy |
| 2 | `SPEC-MK-032` | 最终覆盖审计与发布就绪 | 14-testing-strategy, README |
