...
实现授权、RBAC 与 Scope，并以可测试契约接入相邻领域。
...
|---|---|---|---|
| 1 | `SPEC-UA-011` | 角色与权限模型 | 01-domain-model, 02-business-invariants |
| 2 | `SPEC-UA-012` | 角色分配生命周期 | 03-state-machine, 04-use-cases |
| 3 | `SPEC-UA-013` | Tenant 与 Support Queue Scope | 02-business-invariants, 11-security |
| 4 | `SPEC-UA-014` | Authorization Context 与 Decision API | 05-api-contracts, 11-security |
| 5 | `SPEC-UA-015` | Self-Service 与资源所有权 | 02-business-invariants, 04-use-cases |
