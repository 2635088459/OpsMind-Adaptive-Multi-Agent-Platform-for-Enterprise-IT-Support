...
|---|---|---|---|
| 1 | `SPEC-UA-029` | 身份安全审计事件 | 06-event-contracts, 12-observability |
| 2 | `SPEC-UA-030` | 身份 Metrics、Logs 与 Traces | 12-observability |
| 3 | `SPEC-UA-031` | 隐私、数据最小化与保留 | 07-data-model, 11-security |
