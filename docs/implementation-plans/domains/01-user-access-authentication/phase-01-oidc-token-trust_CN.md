...
实现OIDC 与 Token 信任，并以可测试契约接入相邻领域。
...
|---|---|---|---|
| 1 | `SPEC-UA-004` | OIDC Provider Discovery 与配置 | 05-api-contracts, 11-security |
| 2 | `SPEC-UA-005` | Authorization Code + PKCE 登录回调 | 04-use-cases, 05-api-contracts |
| 3 | `SPEC-UA-006` | JWT 校验与 JWKS 轮换 | 11-security, 10-failure-handling |
| 4 | `SPEC-UA-007` | Principal Claims 标准化 | 01-domain-model, 05-api-contracts |
