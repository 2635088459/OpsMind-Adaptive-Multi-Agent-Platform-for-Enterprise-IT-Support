...
| 顺序 | SPEC | 名称 |
|---|---|---|
| 1 | `SPEC-OP-012` | Prometheus Metrics 后端 |
| 2 | `SPEC-OP-013` | Loki Log 后端 |
| 3 | `SPEC-OP-014` | Tempo Trace 后端 |
| 4 | `SPEC-OP-015` | 遥测保留、压缩与存储 |
