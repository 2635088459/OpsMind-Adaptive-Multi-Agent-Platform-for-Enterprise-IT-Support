# Phase 07 — Runtime Event Publishing
...
> Phase: 07
>
> Specs: `SPEC-ARO-025` to `SPEC-ARO-027`
>
...
Publish workflow and agent.task events through Runtime outbox without synchronous broker publishing in transactions.
...
|---|---|---|---|
| 1 | `SPEC-ARO-025` | Publish Workflow Lifecycle Events | 06-event-contracts, 08-transaction-and-outbox |
| 2 | `SPEC-ARO-026` | Publish Agent Task Events | 06-event-contracts, 12-observability |
| 3 | `SPEC-ARO-027` | Publish Workflow Terminal Events | 06-event-contracts, 03-state-machine |
