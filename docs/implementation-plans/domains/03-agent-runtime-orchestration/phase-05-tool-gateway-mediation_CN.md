# Phase 05 — Tool Gateway Mediation（Tool Gateway 中介）
...
> Phase：05
>
> Specs：`SPEC-ARO-017` ～ `SPEC-ARO-020`
>
...
强制 Agent 不能直连 Tool，所有工具副作用必须通过 Runtime 持久化 Tool Request 并经 Tool Gateway。
...
|---|---|---|---|
| 1 | `SPEC-ARO-017` | Tool Request 聚合 | 01-domain-model, 07-data-model |
| 2 | `SPEC-ARO-018` | 禁止 Agent 直连 Tool | 02-business-invariants, 11-security |
| 3 | `SPEC-ARO-019` | 通过 Tool Gateway 派发 Tool Request | 08-transaction-and-outbox, 11-security |
| 4 | `SPEC-ARO-020` | 消费 tool.completed 与 tool.failed | 04-use-cases, 06-event-contracts |
