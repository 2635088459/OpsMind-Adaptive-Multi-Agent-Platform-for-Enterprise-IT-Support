# Phase 01 — Workflow Instance Lifecycle（Workflow Instance 生命周期）
...
> Phase：01
>
> Specs：`SPEC-ARO-004` ～ `SPEC-ARO-006`
>
...
定义 Workflow Instance aggregate，并从 `ticket.created` 启动自动化编排实例。
...
|---|---|---|---|
| 1 | `SPEC-ARO-004` | Workflow Instance 聚合 | 01-domain-model, 03-state-machine |
| 2 | `SPEC-ARO-005` | 从 ticket.created 启动 Workflow | 04-use-cases, 06-event-contracts |
| 3 | `SPEC-ARO-006` | Workflow 查询与运维视图 | 05-api-contracts, 12-observability |
