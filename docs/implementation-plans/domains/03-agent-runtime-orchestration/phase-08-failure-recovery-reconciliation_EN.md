# Phase 08 — Failure Recovery and Reconciliation
...
> Phase: 08
>
> Specs: `SPEC-ARO-028` to `SPEC-ARO-031`
>
...
Implement runtime crash recovery, expired lease recovery, outbox replay, and admin reconciliation repair.
...
|---|---|---|---|
| 1 | `SPEC-ARO-028` | Recovery Scanner and Checkpoint Restore | 10-failure-handling, 01-domain-model |
| 2 | `SPEC-ARO-029` | Expired Lease Task Recovery | 09-concurrency-and-idempotency, 10-failure-handling |
| 3 | `SPEC-ARO-030` | Outbox Replay and Publisher Recovery | 08-transaction-and-outbox, 10-failure-handling |
| 4 | `SPEC-ARO-031` | Admin Reconciliation and Repair | 10-failure-handling, 05-api-contracts |
