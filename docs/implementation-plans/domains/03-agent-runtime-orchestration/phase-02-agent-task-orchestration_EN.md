...
> Phase: 02
>
> Specs: `SPEC-ARO-007` to `SPEC-ARO-010`
>
...
Build Agent Task, planner task graph, claim lease, completion, and join policy.
...
|---|---|---|---|
| 1 | `SPEC-ARO-007` | Agent Task Aggregate | 01-domain-model, 03-state-machine |
...
| 4 | `SPEC-ARO-010` | Task Completion and Join Policy | 02-business-invariants, 08-transaction-and-outbox |
