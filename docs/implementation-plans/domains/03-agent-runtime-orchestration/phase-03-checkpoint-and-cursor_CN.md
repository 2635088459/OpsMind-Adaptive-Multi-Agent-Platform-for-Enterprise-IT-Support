# Phase 03 — Checkpoint and Cursor（Checkpoint 与 Cursor）
...
> Phase：03
>
> Specs：`SPEC-ARO-011` ～ `SPEC-ARO-013`
>
...
实现可恢复 checkpoint、等待状态快照和事件处理 cursor/processed-event 去重。
...
|---|---|---|---|
| 1 | `SPEC-ARO-011` | Checkpoint 存储 | 01-domain-model, 07-data-model |
| 2 | `SPEC-ARO-012` | 外部等待前后的 Checkpoint | 03-state-machine, 08-transaction-and-outbox |
| 3 | `SPEC-ARO-013` | Event Cursor 与 Processed Events | 01-domain-model, 09-concurrency-and-idempotency |
