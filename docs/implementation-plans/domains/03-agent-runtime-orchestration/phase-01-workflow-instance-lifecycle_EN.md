# Phase 01 — Workflow Instance Lifecycle
...
> Phase: 01
>
> Specs: `SPEC-ARO-004` to `SPEC-ARO-006`
>
...
Define the Workflow Instance aggregate and start automation instances from `ticket.created`.
...
|---|---|---|---|
| 1 | `SPEC-ARO-004` | Workflow Instance Aggregate | 01-domain-model, 03-state-machine |
| 2 | `SPEC-ARO-005` | Start Workflow From ticket.created | 04-use-cases, 06-event-contracts |
| 3 | `SPEC-ARO-006` | Workflow Query and Admin View | 05-api-contracts, 12-observability |
