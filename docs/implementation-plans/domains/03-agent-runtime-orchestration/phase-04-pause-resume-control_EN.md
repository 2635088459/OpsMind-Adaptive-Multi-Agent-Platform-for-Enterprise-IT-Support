...
> Phase: 04
>
> Specs: `SPEC-ARO-014` to `SPEC-ARO-016`
>
...
Implement idempotent pause/resume commands, pause generation, and stale worker-result protection.
...
|---|---|---|---|
| 1 | `SPEC-ARO-014` | Pause Workflow Command | 04-use-cases, 09-concurrency-and-idempotency |
| 2 | `SPEC-ARO-015` | Resume Workflow Command | 04-use-cases, 09-concurrency-and-idempotency |
| 3 | `SPEC-ARO-016` | Stale Generation Worker Result | 02-business-invariants, 10-failure-handling |
