# Phase 00 — Engineering Foundation（工程基础）
...
> Phase：00
>
> Specs：`SPEC-ARO-001` ～ `SPEC-ARO-003`
>
...
建立 Agent Runtime Orchestration 的工程边界、schema 基线、outbox 与幂等基础设施。
...
|---|---|---|---|
| 1 | `SPEC-ARO-001` | Runtime 模块与包边界 | 13-package-and-class-design, 02-business-invariants |
| 2 | `SPEC-ARO-002` | Agent Runtime Schema 基线 | 07-data-model |
| 3 | `SPEC-ARO-003` | Runtime Outbox 与幂等基线 | 08-transaction-and-outbox, 09-concurrency-and-idempotency |
