# Phase 06 — External Event Consumption（外部事件消费）
...
> Phase：06
>
> Specs：`SPEC-ARO-021` ～ `SPEC-ARO-024`
>
...
消费 approval、verification、ticket cycle 变化等外部事件，并处理 duplicate、stale、invalid 分类。
...
|---|---|---|---|
| 1 | `SPEC-ARO-021` | 消费 Approval Events | 04-use-cases, 06-event-contracts |
| 2 | `SPEC-ARO-022` | 消费 Verification Events | 04-use-cases, 06-event-contracts |
| 3 | `SPEC-ARO-023` | 消费 Ticket Cycle Events | 06-event-contracts, 10-failure-handling |
| 4 | `SPEC-ARO-024` | Duplicate Stale Invalid Event 分类 | 09-concurrency-and-idempotency, 10-failure-handling |
