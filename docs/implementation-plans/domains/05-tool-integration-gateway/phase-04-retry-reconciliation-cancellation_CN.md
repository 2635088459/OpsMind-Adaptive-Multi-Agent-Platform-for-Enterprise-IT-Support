...
实现 retry policy、timeout/partial side effect reconciliation、cancel 流程和 connector health 状态。
...
|---|---|---|---|
| 1 | `SPEC-TG-016` | Retry Policy 与重试调度 | 10-failure-handling, 09-concurrency-and-idempotency |
| 2 | `SPEC-TG-017` | Timeout 与 Partial Side Effect 对账 | 10-failure-handling, 03-state-machine |
| 3 | `SPEC-TG-018` | Tool Request 取消流程 | 04-use-cases, 09-concurrency-and-idempotency, 05-api-contracts |
| 4 | `SPEC-TG-019` | Connector Health 与降级控制 | 03-state-machine, 10-failure-handling, 12-observability |
