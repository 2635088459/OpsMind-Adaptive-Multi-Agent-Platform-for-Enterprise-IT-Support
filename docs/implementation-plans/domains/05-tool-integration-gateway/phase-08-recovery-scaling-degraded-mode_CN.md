...
实现 crash recovery、backpressure、worker scaling 和 degraded execution control。
...
|---|---|---|---|
| 1 | `SPEC-TG-030` | Crash Recovery、Backpressure 与 Scaling | 10-failure-handling, 09-concurrency-and-idempotency, 12-observability |
