...
落实 secret isolation、raw output 受控访问、授权 scope 与 network policy。
...
|---|---|---|---|
| 1 | `SPEC-TG-020` | Secret 隔离与 Raw Output 受控访问 | 11-security, 05-api-contracts |
| 2 | `SPEC-TG-021` | 授权 Scope 与 Network Policy | 11-security, 02-business-invariants |
