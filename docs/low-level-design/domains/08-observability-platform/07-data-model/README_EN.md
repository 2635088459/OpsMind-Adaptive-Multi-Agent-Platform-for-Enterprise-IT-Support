# 07-data-model — Configuration And Telemetry Data Model
...
This section defines implementation-ready configuration and telemetry data model for the telemetry data plane and operational control plane. Assets include TelemetrySource, SignalContract, CollectorPipeline, BackendTenant, DashboardDefinition, AlertRule, SloDefinition, RunbookReference, RetentionPolicy, Silence and ConfigurationRelease. Each asset has owner, environment, version, labels, lifecycle, access policy, audit reference and rollback reference.
