# 11-security — Security And Privacy
...
This section defines implementation-ready security and privacy for the telemetry data plane and operational control plane. Assets include TelemetrySource, SignalContract, CollectorPipeline, BackendTenant, DashboardDefinition, AlertRule, SloDefinition, RunbookReference, RetentionPolicy, Silence and ConfigurationRelease. Each asset has owner, environment, version, labels, lifecycle, access policy, audit reference and rollback reference.
