...
> **Dependencies:** `01-domain-model/README_EN.md` through `10-failure-handling/README_EN.md`  
> **Recommended Path:** `docs/low-level-design/domains/02-ticket-workflow/11-security/README_EN.md`
...
```text
12-observability/README_CN.md
12-observability/README_EN.md
```
