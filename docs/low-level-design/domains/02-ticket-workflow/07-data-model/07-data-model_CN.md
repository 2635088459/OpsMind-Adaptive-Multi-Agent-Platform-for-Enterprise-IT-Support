...
> **依赖：** `01-domain-model_CN.md`、`02-business-invariants_CN.md`、`03-state-machine_CN.md`、`04-use-cases_CN.md`、`05-api-contracts_CN.md`、`06-event-contracts_CN.md`  
> **数据库：** PostgreSQL 18.x  
> **Migration：** Flyway  
> **建议路径：** `System Design/Lower Structure Design_1.0/02-Ticket-Workflow/07-data-model_CN.md`
