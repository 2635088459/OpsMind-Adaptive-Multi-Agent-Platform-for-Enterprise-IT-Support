...
> **Dependencies:** `01-domain-model_EN.md`, `02-business-invariants_EN.md`, `03-state-machine_EN.md`  
> **Recommended Path:** `System Design/Lower Structure Design_1.0/02-Ticket-Workflow/04-use-cases_EN.md`
