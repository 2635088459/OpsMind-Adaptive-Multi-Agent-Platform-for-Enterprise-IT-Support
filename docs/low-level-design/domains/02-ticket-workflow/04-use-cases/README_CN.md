...
> **依赖：** `01-domain-model/README_CN.md`、`02-business-invariants/README_CN.md`、`03-state-machine/README_CN.md`  
> **建议路径：** `docs/low-level-design/domains/02-ticket-workflow/04-use-cases/README_CN.md`
