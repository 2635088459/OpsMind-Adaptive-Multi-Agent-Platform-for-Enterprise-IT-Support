...
> **依赖：** `01-domain-model/README_CN.md` 至 `13-package-and-class-design/README_CN.md`  
...
> **建议路径：** `docs/low-level-design/domains/02-ticket-workflow/14-testing-strategy/README_CN.md`
