...
> **Dependency:** `04-use-cases_EN.md`  
> **Standard:** REST + OpenAPI 3.1  
> **Recommended Path:** `System Design/Lower Structure Design_1.0/02-Ticket-Workflow/05-api-contracts_EN.md`
...
```text
06-event-contracts_CN.md
06-event-contracts_EN.md
```
