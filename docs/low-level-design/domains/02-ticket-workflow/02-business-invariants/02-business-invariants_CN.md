...
> **版本：** 1.0  
> **状态：** Proposed  
> **依赖：** `01-domain-model_CN.md`  
> **建议路径：** `System Design/Lower Structure Design_1.0/02-Ticket-Workflow/02-business-invariants_CN.md`
...
本文档不描述完整状态转换矩阵。状态转换细节将在 `03-state-machine_CN.md` 中定义。
...
`03-state-machine_CN.md` 必须基于本文档生成。
...
- [x] 测试映射已定义。
- [ ] 最终状态转换将在 `03-state-machine_CN.md` 中冻结。
