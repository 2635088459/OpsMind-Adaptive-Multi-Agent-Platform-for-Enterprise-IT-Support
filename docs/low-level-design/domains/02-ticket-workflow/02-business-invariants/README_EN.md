...
> **Version:** 1.0  
> **Status:** Proposed  
> **Dependency:** `01-domain-model/README_EN.md`  
> **Recommended Path:** `docs/low-level-design/domains/02-ticket-workflow/02-business-invariants/README_EN.md`
...
The complete transition matrix is defined later in `03-state-machine/README_EN.md`.
...
`03-state-machine/README_EN.md` must reference the `BI-xxx` identifiers.
...
- [ ] Final transitions will be frozen in `03-state-machine/README_EN.md`
