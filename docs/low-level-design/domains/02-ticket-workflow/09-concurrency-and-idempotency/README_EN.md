...
> **Dependencies:** `02-business-invariants/README_EN.md`, `03-state-machine/README_EN.md`, `04-use-cases/README_EN.md`, `05-api-contracts/README_EN.md`, `06-event-contracts/README_EN.md`, `07-data-model/README_EN.md`, `08-transaction-and-outbox/README_EN.md`  
> **Concurrency Model:** Optimistic Concurrency + Database Constraints + Idempotent Commands + Idempotent Consumers  
> **Recommended Path:** `docs/low-level-design/domains/02-ticket-workflow/09-concurrency-and-idempotency/README_EN.md`
