...
> **Dependencies:** `04-use-cases/README_EN.md`, `06-event-contracts/README_EN.md`, `07-data-model/README_EN.md`  
> **Database:** PostgreSQL 18.x  
> **Message Broker:** RabbitMQ  
> **Transaction Model:** Local ACID Transaction + Transactional Outbox + Idempotent Consumer  
> **Recommended Path:** `docs/low-level-design/domains/02-ticket-workflow/08-transaction-and-outbox/README_EN.md`
