...
> **Dependencies:** `04-use-cases_EN.md`, `05-api-contracts_EN.md`  
> **Message Broker:** RabbitMQ  
> **Schema Standard:** JSON Schema Draft 2020-12  
> **Delivery Semantics:** At-least-once Delivery + Idempotent Consumer  
> **Recommended Path:** `System Design/Lower Structure Design_1.0/02-Ticket-Workflow/06-event-contracts_EN.md`
