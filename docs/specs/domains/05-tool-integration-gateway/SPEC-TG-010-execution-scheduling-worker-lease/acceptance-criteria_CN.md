...
- 能完成目标：实现 queued request 调度、worker claim、lease expiry 和 active attempt 唯一性。
- 所有状态迁移符合 `03-state-machine, 08-transaction-and-outbox, 09-concurrency-and-idempotency` 中定义的规则。
