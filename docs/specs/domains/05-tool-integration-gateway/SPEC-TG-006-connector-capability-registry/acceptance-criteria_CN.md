...
- 能完成目标：实现 connector manifest、capability registry、schema version 和 connector selection 的基础能力。
- 所有状态迁移符合 `01-domain-model, 05-api-contracts, 07-data-model` 中定义的规则。
