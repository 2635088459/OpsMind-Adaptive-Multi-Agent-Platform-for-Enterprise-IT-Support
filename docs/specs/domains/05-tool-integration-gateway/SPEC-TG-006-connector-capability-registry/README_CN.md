# SPEC-TG-006 — Connector 与 Capability Registry
...
>
> LLD 映射：`01-domain-model, 05-api-contracts, 07-data-model`
>
> 文档状态：Spec Planning

## 1. 目标

实现 connector manifest、capability registry、schema version 和 connector selection 的基础能力。
