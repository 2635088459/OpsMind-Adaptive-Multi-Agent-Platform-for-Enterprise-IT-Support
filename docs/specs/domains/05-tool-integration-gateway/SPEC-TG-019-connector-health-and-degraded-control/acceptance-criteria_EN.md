# Acceptance Criteria — SPEC-TG-019

## Functional Acceptance

- The implementation fulfills the goal: Implement ACTIVE/DEGRADED/DISABLED/DEPRECATED states and scheduling restrictions.
- All state transitions follow rules from `03-state-machine, 10-failure-handling, 12-observability`.
