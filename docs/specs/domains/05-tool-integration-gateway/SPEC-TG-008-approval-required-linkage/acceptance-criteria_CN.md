...
- 能完成目标：保存 approval linkage，发布 tool.approval.required，并保持 WAITING_APPROVAL 幂等。
- 所有状态迁移符合 `03-state-machine, 06-event-contracts, 08-transaction-and-outbox` 中定义的规则。
