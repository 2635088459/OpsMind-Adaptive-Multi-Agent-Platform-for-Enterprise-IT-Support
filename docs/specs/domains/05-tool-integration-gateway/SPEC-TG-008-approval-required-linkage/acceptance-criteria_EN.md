# Acceptance Criteria — SPEC-TG-008

## Functional Acceptance

- The implementation fulfills the goal: Persist approval linkage, publish tool.approval.required, and keep WAITING_APPROVAL idempotent.
- All state transitions follow rules from `03-state-machine, 06-event-contracts, 08-transaction-and-outbox`.
