# SPEC-TG-017 — Timeout 与 Partial Side Effect 对账
...
>
> LLD 映射：`10-failure-handling, 03-state-machine`
>
> 文档状态：Spec Planning

## 1. 目标

实现 timeout/partial side effect 的 reconciliation worker 和 uncertain final result。
