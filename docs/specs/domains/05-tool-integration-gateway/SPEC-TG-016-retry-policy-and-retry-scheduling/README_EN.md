# SPEC-TG-016 — Retry Policy And Retry Scheduling
...
>
> LLD Mapping: `10-failure-handling, 09-concurrency-and-idempotency`
>
> Document Status: Spec Planning

## 1. Goal

Implement retryable/non-retryable classification, backoff, max attempts, and retry_scheduled event.
