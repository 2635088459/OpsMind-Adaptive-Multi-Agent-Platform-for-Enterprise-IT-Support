# SPEC-TG-016 — Retry Policy 与重试调度
...
>
> LLD 映射：`10-failure-handling, 09-concurrency-and-idempotency`
>
> 文档状态：Spec Planning

## 1. 目标

实现 retryable/non-retryable 分类、backoff、max attempts 和 retry_scheduled event。
