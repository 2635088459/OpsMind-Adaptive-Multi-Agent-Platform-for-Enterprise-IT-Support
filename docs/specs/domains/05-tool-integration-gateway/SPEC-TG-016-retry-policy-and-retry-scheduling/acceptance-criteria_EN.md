# Acceptance Criteria — SPEC-TG-016

## Functional Acceptance

- The implementation fulfills the goal: Implement retryable/non-retryable classification, backoff, max attempts, and retry_scheduled event.
- All state transitions follow rules from `10-failure-handling, 09-concurrency-and-idempotency`.
