# SPEC-TG-021 — Authorization Scope And Network Policy
...
Implement authorization using tenant/actor/ticket/capability/credential scope and connector egress allowlist.
