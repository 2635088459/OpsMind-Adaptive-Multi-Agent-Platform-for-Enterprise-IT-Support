# Acceptance Criteria — SPEC-TG-011

## Functional Acceptance

- The implementation fulfills the goal: Define ConnectorPort contract and provide fake connector for tests and later real connectors.
- All state transitions follow rules from `13-package-and-class-design, 14-testing-strategy`.
