# SPEC-TG-011 — Connector SDK 与内置 Fake Connector
...
>
> LLD 映射：`13-package-and-class-design, 14-testing-strategy`
>
> 文档状态：Spec Planning

## 1. 目标

定义 ConnectorPort contract，并提供 fake connector 支撑测试和后续真实 connector。
