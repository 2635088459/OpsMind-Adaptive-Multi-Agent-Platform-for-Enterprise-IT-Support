# Acceptance Criteria — SPEC-TG-012

## Functional Acceptance

- The implementation fulfills the goal: Implement credential binding resolution, short-lived credential handles, and invocation spec preparation.
- All state transitions follow rules from `01-domain-model, 11-security`.
