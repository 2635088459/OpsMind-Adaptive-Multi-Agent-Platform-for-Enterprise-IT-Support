# SPEC-TG-014 — Result Envelope 标准化与脱敏
...
>
> LLD 映射：`01-domain-model, 11-security, 05-api-contracts`
>
> 文档状态：Spec Planning

## 1. 目标

把 connector output 标准化为 ToolResultEnvelope，并完成 classification/redaction。
