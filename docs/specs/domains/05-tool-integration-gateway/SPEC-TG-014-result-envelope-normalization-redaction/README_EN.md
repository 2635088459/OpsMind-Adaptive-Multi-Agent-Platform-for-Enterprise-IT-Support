# SPEC-TG-014 — Result Envelope Normalization Redaction
...
>
> LLD Mapping: `01-domain-model, 11-security, 05-api-contracts`
>
> Document Status: Spec Planning

## 1. Goal

Normalize connector output into ToolResultEnvelope with classification/redaction.
