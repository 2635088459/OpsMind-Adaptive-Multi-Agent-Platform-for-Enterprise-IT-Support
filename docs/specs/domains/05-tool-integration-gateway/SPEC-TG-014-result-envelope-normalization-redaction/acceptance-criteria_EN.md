# Acceptance Criteria — SPEC-TG-014

## Functional Acceptance

- The implementation fulfills the goal: Normalize connector output into ToolResultEnvelope with classification/redaction.
- All state transitions follow rules from `01-domain-model, 11-security, 05-api-contracts`.
