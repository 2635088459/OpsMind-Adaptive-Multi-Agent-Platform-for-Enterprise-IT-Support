# SPEC-TG-020 — Secret Isolation And Raw Output Access
...
Ensure secrets do not enter logs/events/results/memory and implement audited privileged raw-output access.
