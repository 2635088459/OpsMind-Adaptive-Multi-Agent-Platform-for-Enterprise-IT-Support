# Acceptance Criteria — SPEC-TG-015

## Functional Acceptance

- The implementation fulfills the goal: Publish tool.completed.v1 through outbox after final outcome so Runtime can resume idempotently.
