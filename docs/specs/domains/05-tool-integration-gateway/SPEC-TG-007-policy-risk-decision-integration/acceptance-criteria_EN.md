# Acceptance Criteria — SPEC-TG-007

## Functional Acceptance

- The implementation fulfills the goal: Integrate policy/risk decision for auto approval, approval required, and policy denial.
- All state transitions follow rules from `02-business-invariants, 04-use-cases, 06-event-contracts`.
