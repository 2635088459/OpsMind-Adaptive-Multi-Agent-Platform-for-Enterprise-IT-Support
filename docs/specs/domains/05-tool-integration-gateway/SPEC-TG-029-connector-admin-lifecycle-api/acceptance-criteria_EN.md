# Acceptance Criteria — SPEC-TG-029

## Functional Acceptance

- The implementation fulfills the goal: Implement connector register/enable/disable/deprecate/health admin APIs.
- All state transitions follow rules from `05-api-contracts, 03-state-machine`.
