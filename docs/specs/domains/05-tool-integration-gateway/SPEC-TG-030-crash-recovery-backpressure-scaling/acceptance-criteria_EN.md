# Acceptance Criteria — SPEC-TG-030

## Functional Acceptance

- The implementation fulfills the goal: Implement startup recovery, lease scan, backpressure, worker scaling, and degraded mode controls.
- All state transitions follow rules from `10-failure-handling, 09-concurrency-and-idempotency, 12-observability`.
