...
- 能完成目标：实现启动恢复、lease 扫描、backpressure、worker scaling 和 degraded mode 控制。
- 所有状态迁移符合 `10-failure-handling, 09-concurrency-and-idempotency, 12-observability` 中定义的规则。
