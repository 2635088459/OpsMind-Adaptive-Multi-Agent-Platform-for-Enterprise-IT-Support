# SPEC-TG-030 — Crash Recovery、Backpressure 与 Scaling
...
>
> LLD 映射：`10-failure-handling, 09-concurrency-and-idempotency, 12-observability`
>
> 文档状态：Spec Planning

## 1. 目标

实现启动恢复、lease 扫描、backpressure、worker scaling 和 degraded mode 控制。
