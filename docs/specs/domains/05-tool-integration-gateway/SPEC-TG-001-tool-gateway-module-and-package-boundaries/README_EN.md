# SPEC-TG-001 — Tool Gateway Module And Package Boundaries
...
Create service skeleton, layered package boundaries, ports/adapters, and architecture constraints forbidding direct Agent tool calls.
