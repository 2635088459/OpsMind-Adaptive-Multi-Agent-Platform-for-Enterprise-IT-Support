# SPEC-MK-006 Acceptance Criteria

## Criteria

- Deliver the minimum closed-loop capability for `Working Memory Query Archive`.
- Cover LLD mapping: `05-api-contracts, 03-state-machine`.
