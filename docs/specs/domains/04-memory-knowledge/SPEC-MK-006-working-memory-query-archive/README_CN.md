# SPEC-MK-006 — Working Memory 查询与归档
...
>
> LLD 映射：`05-api-contracts, 03-state-machine`
>
> 文档状态：Spec Planning

## 1. 目标

Implement query latest and archive/delete/tombstone paths.
...
- Archive on cycle completion; reopen creates a new scope.
