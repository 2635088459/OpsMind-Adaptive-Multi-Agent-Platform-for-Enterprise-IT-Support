# SPEC-MK-022 API Contract

## API Scope

This spec scopes API work to the `cross-domain` capability. If it exposes no HTTP API, entry must be through an application service or event consumer.
