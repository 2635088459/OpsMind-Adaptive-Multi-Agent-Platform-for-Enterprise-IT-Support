# SPEC-MK-014 Acceptance Criteria

## Criteria

- Deliver the minimum closed-loop capability for `Memory And Version Aggregate`.
- Cover LLD mapping: `01-domain-model, 03-state-machine`.
