# SPEC-MK-017 — Hybrid Retrieval Engine
...
>
> LLD 映射：`04-use-cases, 05-api-contracts, 07-data-model`
>
> 文档状态：Spec Planning

## 1. 目标

Implement vector + keyword + metadata filtered retrieval.
...
- Score combines semantic, keyword, recency, trust, validation, and success signals.
