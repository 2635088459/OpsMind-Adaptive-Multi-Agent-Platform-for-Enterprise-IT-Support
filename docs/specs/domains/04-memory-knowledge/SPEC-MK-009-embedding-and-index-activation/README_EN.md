# SPEC-MK-009 — Embedding And Index Activation
...
>
> LLD Mapping: `07-data-model, 08-transaction-and-outbox, 10-failure-handling`
>
> Document Status: Spec Planning

## 1. Goal

Generate embeddings and activate searchable document versions.
...
- Document not searchable until embedded/indexed/active.
