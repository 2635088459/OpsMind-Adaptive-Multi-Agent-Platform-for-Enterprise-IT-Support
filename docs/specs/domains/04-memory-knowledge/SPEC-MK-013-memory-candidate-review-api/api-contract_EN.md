# SPEC-MK-013 API Contract

## API Scope

This spec scopes API work to the `candidate-pipeline` capability. If it exposes no HTTP API, entry must be through an application service or event consumer.
