# SPEC-MK-004 Acceptance Criteria

## Criteria

- Deliver the minimum closed-loop capability for `Working Memory Aggregate`.
- Cover LLD mapping: `01-domain-model, 02-business-invariants`.
