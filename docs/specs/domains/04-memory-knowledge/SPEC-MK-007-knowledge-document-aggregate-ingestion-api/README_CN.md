# SPEC-MK-007 — Knowledge Document 聚合与导入 API
...
>
> LLD 映射：`01-domain-model, 05-api-contracts`
>
> 文档状态：Spec Planning

## 1. 目标

Implement KnowledgeDocument aggregate and admin ingestion API.
...
- sourceSystem+externalId+version is idempotent; ACL/classification required.
