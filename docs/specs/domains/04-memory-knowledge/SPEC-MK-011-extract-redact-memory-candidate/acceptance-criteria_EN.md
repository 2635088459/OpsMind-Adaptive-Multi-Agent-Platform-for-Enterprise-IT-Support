# SPEC-MK-011 Acceptance Criteria

## Criteria

- Deliver the minimum closed-loop capability for `Extract And Redact Memory Candidate`.
- Cover LLD mapping: `01-domain-model, 04-use-cases, 11-security`.
