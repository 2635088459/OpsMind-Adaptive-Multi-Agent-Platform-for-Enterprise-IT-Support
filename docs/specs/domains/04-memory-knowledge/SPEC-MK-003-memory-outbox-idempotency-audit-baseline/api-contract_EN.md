# SPEC-MK-003 API Contract

## API Scope

This spec scopes API work to the `foundation` capability. If it exposes no HTTP API, entry must be through an application service or event consumer.
