# SPEC-MK-031 API Contract

## API Scope

This spec scopes API work to the `release` capability. If it exposes no HTTP API, entry must be through an application service or event consumer.
