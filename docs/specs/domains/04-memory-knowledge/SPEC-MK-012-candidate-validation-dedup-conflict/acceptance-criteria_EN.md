# SPEC-MK-012 Acceptance Criteria

## Criteria

- Deliver the minimum closed-loop capability for `Candidate Validation Dedup Conflict`.
- Cover LLD mapping: `02-business-invariants, 03-state-machine`.
