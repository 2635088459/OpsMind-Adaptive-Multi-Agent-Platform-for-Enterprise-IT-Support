# SPEC-MK-029 API Contract

## API Scope

This spec scopes API work to the `ops` capability. If it exposes no HTTP API, entry must be through an application service or event consumer.
