# SPEC-MK-030 Acceptance Criteria

## Criteria

- Deliver the minimum closed-loop capability for `Admin Repair Reindex Replay`.
- Cover LLD mapping: `05-api-contracts, 10-failure-handling`.
