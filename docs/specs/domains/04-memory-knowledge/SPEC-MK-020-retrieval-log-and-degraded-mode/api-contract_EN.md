# SPEC-MK-020 API Contract

## API Scope

This spec scopes API work to the `retrieval-graph` capability. If it exposes no HTTP API, entry must be through an application service or event consumer.
