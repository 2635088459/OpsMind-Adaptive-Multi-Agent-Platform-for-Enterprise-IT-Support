# SPEC-UA-032 — IdP Outage And JWKS Degraded Mode
...
Implement IdP Outage And JWKS Degraded Mode as an encodable, auditable, recoverable capability with cross-domain contract tests.
