# SPEC-UA-005 — Authorization Code PKCE Login Callback
...
Implement Authorization Code PKCE Login Callback as an encodable, auditable, recoverable capability with cross-domain contract tests.
