# SPEC-UA-029 — Identity Security Audit Events
...
Implement Identity Security Audit Events as an encodable, auditable, recoverable capability with cross-domain contract tests.
