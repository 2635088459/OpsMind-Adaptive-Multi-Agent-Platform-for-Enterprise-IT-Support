# SPEC-UA-004 — OIDC Provider Discovery And Configuration
...
Implement OIDC Provider Discovery And Configuration as an encodable, auditable, recoverable capability with cross-domain contract tests.
