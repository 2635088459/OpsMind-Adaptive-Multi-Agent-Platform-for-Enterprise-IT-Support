# SPEC-UA-007 — Principal Claims Normalization
...
Implement Principal Claims Normalization as an encodable, auditable, recoverable capability with cross-domain contract tests.
