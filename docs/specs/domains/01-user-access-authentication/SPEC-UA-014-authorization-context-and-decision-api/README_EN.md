# SPEC-UA-014 — Authorization Context And Decision API
...
Implement Authorization Context And Decision API as an encodable, auditable, recoverable capability with cross-domain contract tests.
