# SPEC-UA-002 — Identity Schema Baseline
...
Implement Identity Schema Baseline as an encodable, auditable, recoverable capability with cross-domain contract tests.
