# SPEC-TW-026 Acceptance Criteria

## Functional Acceptance

- Given the Ticket is in an allowed state, submitting `confirmResolution` applies the `CLOSED` outcome.
- `ticket.resolution-confirmed.v1` is published only after the state or ownership mutation commits.
