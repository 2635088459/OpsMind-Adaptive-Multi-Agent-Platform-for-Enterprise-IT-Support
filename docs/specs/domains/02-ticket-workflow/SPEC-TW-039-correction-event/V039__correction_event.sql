-- Reference migration for SPEC-TW-039 Correction Event
-- Final implementation may split records by case, attempt, and audit tables.

CREATE TABLE IF NOT EXISTS ticket.ticket_phase10_correction_event (
  id UUID PRIMARY KEY,
  ticket_id UUID,
...
CREATE INDEX IF NOT EXISTS idx_ticket_phase10_correction_event_ticket_created
