# SPEC-TW-039 Acceptance Criteria

## Functional Acceptance

- Given a recovery command that satisfies preconditions, the system produces a controlled recovery result and records `ticket.correction-event-published.v1`.
