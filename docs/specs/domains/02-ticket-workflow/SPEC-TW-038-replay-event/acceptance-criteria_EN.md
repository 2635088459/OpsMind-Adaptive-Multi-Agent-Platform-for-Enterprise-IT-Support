# SPEC-TW-038 Acceptance Criteria

## Functional Acceptance

- Given a recovery command that satisfies preconditions, the system produces a controlled recovery result and records `ticket.event-replay-recorded.v1`.
