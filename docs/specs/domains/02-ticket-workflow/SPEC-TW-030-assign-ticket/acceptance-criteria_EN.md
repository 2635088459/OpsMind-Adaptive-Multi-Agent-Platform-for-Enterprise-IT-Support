# SPEC-TW-030 Acceptance Criteria

## Functional Acceptance

- Given the Ticket is in an allowed state, submitting `assignTicket` applies the `same lifecycle state` outcome.
- `ticket.assigned.v1` is published only after the state or ownership mutation commits.
