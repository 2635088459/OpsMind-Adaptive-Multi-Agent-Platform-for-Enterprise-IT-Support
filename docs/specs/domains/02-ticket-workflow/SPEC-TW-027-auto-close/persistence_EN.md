# SPEC-TW-027 Persistence Design
...
Reference migration: `V027__auto_close_ticket.sql`.

Recommended table: `ticket_phase8_auto_close_audit` with fields:
...
- outbox topic/event: `ticket.auto-closed.v1`.
