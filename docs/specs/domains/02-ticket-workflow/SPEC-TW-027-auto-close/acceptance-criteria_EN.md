# SPEC-TW-027 Acceptance Criteria

## Functional Acceptance

- Given the Ticket is in an allowed state, submitting `autoCloseTicket` applies the `CLOSED` outcome.
- `ticket.auto-closed.v1` is published only after the state or ownership mutation commits.
