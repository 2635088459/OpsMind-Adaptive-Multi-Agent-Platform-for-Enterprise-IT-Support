# SPEC-TW-040 Acceptance Criteria

## Functional Acceptance

- Given a recovery command that satisfies preconditions, the system produces a controlled recovery result and records `ticket.compensation-executed.v1`.
