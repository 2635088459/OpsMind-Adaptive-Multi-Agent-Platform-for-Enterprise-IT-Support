-- Reference migration for SPEC-TW-040 Compensation
-- Final implementation may split records by case, attempt, and audit tables.

CREATE TABLE IF NOT EXISTS ticket.ticket_phase10_compensation (
  id UUID PRIMARY KEY,
  ticket_id UUID,
...
CREATE INDEX IF NOT EXISTS idx_ticket_phase10_compensation_ticket_created
