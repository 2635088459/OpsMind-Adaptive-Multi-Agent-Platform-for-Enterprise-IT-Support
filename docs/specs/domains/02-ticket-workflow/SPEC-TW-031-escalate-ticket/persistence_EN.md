# SPEC-TW-031 Persistence Design

## Aggregate Update

- `tickets.state`: target effect `ESCALATED`.
...
Reference migration: `V031__escalate_ticket_phase8.sql`.

Recommended table: `ticket_phase8_escalate_ticket_audit` with fields:
...
- outbox topic/event: `ticket.escalated.v1`.
