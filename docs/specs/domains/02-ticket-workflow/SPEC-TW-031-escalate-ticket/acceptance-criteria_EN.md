# SPEC-TW-031 Acceptance Criteria

## Functional Acceptance

- Given the Ticket is in an allowed state, submitting `escalateTicket` applies the `ESCALATED` outcome.
- `ticket.escalated.v1` is published only after the state or ownership mutation commits.
