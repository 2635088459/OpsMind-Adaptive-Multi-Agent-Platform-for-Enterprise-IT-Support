# SPEC-TW-032 Acceptance Criteria

## Functional Acceptance

- Given the Ticket is in an allowed state, submitting `resumeEscalatedTicket` applies the `IN_PROGRESS` outcome.
- `ticket.escalation-resumed.v1` is published only after the state or ownership mutation commits.
