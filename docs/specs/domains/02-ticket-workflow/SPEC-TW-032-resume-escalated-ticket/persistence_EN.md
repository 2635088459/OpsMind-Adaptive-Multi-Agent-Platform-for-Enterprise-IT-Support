# SPEC-TW-032 Persistence Design

## Aggregate Update

- `tickets.state`: target effect `IN_PROGRESS`.
...
Reference migration: `V032__resume_escalated_ticket.sql`.

Recommended table: `ticket_phase8_resume_escalated_ticket_audit` with fields:
