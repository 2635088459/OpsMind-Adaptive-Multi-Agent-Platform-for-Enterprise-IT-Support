# SPEC-TW-028 Acceptance Criteria

## Functional Acceptance

- Given the Ticket is in an allowed state, submitting `reopenTicket` applies the `REOPENED` outcome.
- `ticket.reopened.v1` is published only after the state or ownership mutation commits.
