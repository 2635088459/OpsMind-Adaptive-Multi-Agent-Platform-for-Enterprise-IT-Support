# SPEC-TW-028 Persistence Design

## Aggregate Update

- `tickets.state`: target effect `REOPENED`.
...
Reference migration: `V028__reopen_ticket.sql`.

Recommended table: `ticket_phase8_reopen_ticket_audit` with fields:
