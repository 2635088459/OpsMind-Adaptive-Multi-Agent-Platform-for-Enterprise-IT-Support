...
成功返回 `201 Created`，并包含 `ETag` 与 `Location`。

错误：`400 VALIDATION_ERROR`、`401 UNAUTHENTICATED`、`403 FORBIDDEN`、`404 TICKET_NOT_FOUND`、`409 INVALID_STATUS_TRANSITION`、`409 USER_INPUT_REQUEST_ALREADY_OPEN`、`412 VERSION_CONFLICT`、`428 PRECONDITION_REQUIRED`。
