# SPEC-TW-037 Acceptance Criteria

## Functional Acceptance

- Given a recovery command that satisfies preconditions, the system produces a controlled recovery result and records `ticket.reconciliation-case-opened.v1`.
