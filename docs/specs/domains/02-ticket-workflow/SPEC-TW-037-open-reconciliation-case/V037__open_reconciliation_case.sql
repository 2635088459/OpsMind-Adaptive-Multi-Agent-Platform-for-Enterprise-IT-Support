-- Reference migration for SPEC-TW-037 Open Reconciliation Case
-- Final implementation may split records by case, attempt, and audit tables.

CREATE TABLE IF NOT EXISTS ticket.ticket_phase10_open_reconciliation_case (
  id UUID PRIMARY KEY,
  ticket_id UUID,
...
CREATE INDEX IF NOT EXISTS idx_ticket_phase10_open_reconciliation_case_ticket_created
