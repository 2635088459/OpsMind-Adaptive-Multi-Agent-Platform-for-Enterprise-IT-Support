...
- The implementation fulfills the goal: Provide approval entry points for admin actions such as outbox replay, poison repair, and manual override.
- All state transitions follow rules from `02-business-invariants, 11-security, 10-failure-handling`.
