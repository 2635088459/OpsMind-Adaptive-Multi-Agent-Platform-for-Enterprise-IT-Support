...
- 能完成目标：确保每个 decision 保存 policy version、constraints、reason codes，避免 policy version race。
- 所有状态迁移符合 `02-business-invariants, 09-concurrency-and-idempotency` 中定义的规则。
