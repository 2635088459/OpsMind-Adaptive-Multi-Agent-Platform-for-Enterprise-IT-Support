# Acceptance Criteria — SPEC-PG-008

## Functional Acceptance

- The implementation fulfills the goal: Ensure every decision stores policy version, constraints, reason codes, and avoids policy version races.
- All state transitions follow rules from `02-business-invariants, 09-concurrency-and-idempotency`.
