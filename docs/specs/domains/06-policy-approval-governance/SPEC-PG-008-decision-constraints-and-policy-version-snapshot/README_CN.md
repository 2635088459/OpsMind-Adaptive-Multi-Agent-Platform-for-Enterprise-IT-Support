# SPEC-PG-008 — Decision Constraints 与 Policy Version Snapshot
...
>
> LLD 映射：`02-business-invariants, 09-concurrency-and-idempotency`
>
> 文档状态：Spec Planning

## 1. 目标

确保每个 decision 保存 policy version、constraints、reason codes，避免 policy version race。
