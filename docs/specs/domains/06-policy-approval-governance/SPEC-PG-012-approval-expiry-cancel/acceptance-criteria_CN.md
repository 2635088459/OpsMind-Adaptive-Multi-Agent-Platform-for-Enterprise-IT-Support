...
- 能完成目标：实现 approval expiry worker、cancel command、expired/cancelled event 和下游区分语义。
- 所有状态迁移符合 `03-state-machine, 10-failure-handling, 08-transaction-and-outbox` 中定义的规则。
