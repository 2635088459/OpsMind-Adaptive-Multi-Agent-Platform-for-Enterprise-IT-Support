# SPEC-PG-012 — Approval Expiry 与 Cancel
...
>
> LLD 映射：`03-state-machine, 10-failure-handling, 08-transaction-and-outbox`
>
> 文档状态：Spec Planning

## 1. 目标

实现 approval expiry worker、cancel command、expired/cancelled event 和下游区分语义。
