# SPEC-PG-012 — Approval Expiry Cancel
...
>
> LLD Mapping: `03-state-machine, 10-failure-handling, 08-transaction-and-outbox`
>
> Document Status: Spec Planning

## 1. Goal

Implement approval expiry worker, cancel command, expired/cancelled events, and downstream-distinct semantics.
