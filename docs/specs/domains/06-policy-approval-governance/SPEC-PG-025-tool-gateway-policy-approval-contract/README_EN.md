# SPEC-PG-025 — 05 Tool Gateway Policy Approval Contract
...
>
> LLD Mapping: `06-event-contracts, 05-api-contracts, 14-testing-strategy`
>
> Document Status: Spec Planning

## 1. Goal

Freeze 05 risk decision API, tool.approval.required, approval granted/denied contracts.
