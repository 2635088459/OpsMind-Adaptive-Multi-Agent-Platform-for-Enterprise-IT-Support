# SPEC-PG-033 — Approval Expiry Poison Recovery Workers
...
>
> LLD Mapping: `10-failure-handling, 08-transaction-and-outbox`
>
> Document Status: Spec Planning

## 1. Goal

Implement expiry, poison decision review, outbox replay, and startup recovery workers.
