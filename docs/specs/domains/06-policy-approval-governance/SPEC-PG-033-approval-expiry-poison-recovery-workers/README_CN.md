# SPEC-PG-033 — Approval Expiry、Poison 与 Recovery Workers
...
>
> LLD 映射：`10-failure-handling, 08-transaction-and-outbox`
>
> 文档状态：Spec Planning

## 1. 目标

实现 expiry、poison decision review、outbox replay 和 startup recovery workers。
