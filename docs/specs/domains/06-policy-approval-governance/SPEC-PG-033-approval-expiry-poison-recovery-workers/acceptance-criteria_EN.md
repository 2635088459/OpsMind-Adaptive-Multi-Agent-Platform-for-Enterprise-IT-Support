# Acceptance Criteria — SPEC-PG-033

## Functional Acceptance

- The implementation fulfills the goal: Implement expiry, poison decision review, outbox replay, and startup recovery workers.
- All state transitions follow rules from `10-failure-handling, 08-transaction-and-outbox`.
