# Acceptance Criteria — SPEC-PG-019

## Functional Acceptance

- The implementation fulfills the goal: Ensure published policy versions are immutable and rule fixes require new versions.
- All state transitions follow rules from `02-business-invariants, 07-data-model`.
