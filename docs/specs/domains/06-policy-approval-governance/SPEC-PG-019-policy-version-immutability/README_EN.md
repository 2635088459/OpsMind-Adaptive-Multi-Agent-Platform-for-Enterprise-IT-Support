# SPEC-PG-019 — Policy Version Immutability
...
>
> LLD Mapping: `02-business-invariants, 07-data-model`
>
> Document Status: Spec Planning

## 1. Goal

Ensure published policy versions are immutable and rule fixes require new versions.
