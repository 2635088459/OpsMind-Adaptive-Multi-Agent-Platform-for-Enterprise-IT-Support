# Acceptance Criteria — SPEC-PG-017

## Functional Acceptance

- The implementation fulfills the goal: Ensure sensitive input does not enter audit/API/logs, storing hashes and metadata by default.
- All state transitions follow rules from `11-security, 12-observability`.
