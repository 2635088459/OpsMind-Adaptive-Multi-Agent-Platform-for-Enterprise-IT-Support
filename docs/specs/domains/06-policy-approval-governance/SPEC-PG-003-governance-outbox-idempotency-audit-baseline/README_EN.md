# SPEC-PG-003 — Governance Outbox Idempotency Audit Baseline
...
Implement governance outbox, processed-event deduplication, command idempotency, and mandatory governance audit.
