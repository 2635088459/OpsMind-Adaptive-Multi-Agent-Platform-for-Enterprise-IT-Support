# Acceptance Criteria — SPEC-PG-006

## Functional Acceptance

- The implementation fulfills the goal: Implement `/policy-decisions:evaluate` API returning allow/deny/approval-required/constraints.
