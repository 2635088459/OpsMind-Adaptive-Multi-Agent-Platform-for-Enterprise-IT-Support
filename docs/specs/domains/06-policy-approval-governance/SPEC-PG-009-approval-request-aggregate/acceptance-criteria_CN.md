# Acceptance Criteria — SPEC-PG-009

## 功能验收

- 能完成目标：实现 ApprovalRequest 聚合、requestKey/requestHash/source linkage 和 REQUESTED/final 状态。
- 所有状态迁移符合 `01-domain-model, 03-state-machine, 07-data-model` 中定义的规则。
