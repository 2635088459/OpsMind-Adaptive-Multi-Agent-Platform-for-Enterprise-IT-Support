# SPEC-PG-009 — Approval Request 聚合
...
>
> LLD 映射：`01-domain-model, 03-state-machine, 07-data-model`
>
> 文档状态：Spec Planning

## 1. 目标

实现 ApprovalRequest 聚合、requestKey/requestHash/source linkage 和 REQUESTED/final 状态。
