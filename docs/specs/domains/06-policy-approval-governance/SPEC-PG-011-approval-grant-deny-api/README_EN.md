# SPEC-PG-011 — Approval Grant Deny API
...
>
> LLD Mapping: `05-api-contracts, 03-state-machine, 09-concurrency-and-idempotency`
>
> Document Status: Spec Planning

## 1. Goal

Implement grant/deny commands, final-decision uniqueness, and concurrent approval conflict handling.
