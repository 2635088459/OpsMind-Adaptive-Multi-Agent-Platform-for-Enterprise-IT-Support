# Acceptance Criteria — SPEC-PG-020

## Functional Acceptance

- The implementation fulfills the goal: Implement policy deprecate, supersede, archive states and policy.published/changed events.
- All state transitions follow rules from `03-state-machine, 06-event-contracts`.
