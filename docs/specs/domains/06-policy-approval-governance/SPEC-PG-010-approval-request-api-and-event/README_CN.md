# SPEC-PG-010 — Approval Request API 与事件
...
>
> LLD 映射：`05-api-contracts, 06-event-contracts, 08-transaction-and-outbox`
>
> 文档状态：Spec Planning

## 1. 目标

实现创建审批请求 API，并通过 outbox 发布 approval.requested.v1。
