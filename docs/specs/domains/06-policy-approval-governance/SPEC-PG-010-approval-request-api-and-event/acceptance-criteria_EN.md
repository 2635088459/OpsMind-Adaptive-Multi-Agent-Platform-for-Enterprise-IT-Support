# Acceptance Criteria — SPEC-PG-010

## Functional Acceptance

- The implementation fulfills the goal: Implement approval request creation API and publish approval.requested.v1 through outbox.
- All state transitions follow rules from `05-api-contracts, 06-event-contracts, 08-transaction-and-outbox`.
