# SPEC-PG-030 — Governance Audit Query API
...
>
> LLD Mapping: `12-observability, 05-api-contracts, 07-data-model`
>
> Document Status: Spec Planning

## 1. Goal

Implement governance audit chain queries by ticket/source/decision/approval/policy.
