...
- 能完成目标：锁定 04 retention、redaction、sensitive retrieval、memory publication policy decision shape。
- 所有状态迁移符合 `06-event-contracts, 05-api-contracts, 11-security` 中定义的规则。
