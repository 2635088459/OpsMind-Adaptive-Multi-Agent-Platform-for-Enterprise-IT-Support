# Acceptance Criteria — SPEC-PG-028

## Functional Acceptance

- The implementation fulfills the goal: Freeze 04 retention, redaction, sensitive retrieval, and memory publication policy decision shape.
- All state transitions follow rules from `06-event-contracts, 05-api-contracts, 11-security`.
