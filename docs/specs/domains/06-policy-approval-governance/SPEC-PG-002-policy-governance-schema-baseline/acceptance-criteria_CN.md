...
- 能完成目标：建立 policies、policy_versions、policy_decisions、approval_requests、approval_decisions、audit、outbox、processed_events 的数据库 baseline。
- 所有状态迁移符合 `07-data-model, 03-state-machine` 中定义的规则。
