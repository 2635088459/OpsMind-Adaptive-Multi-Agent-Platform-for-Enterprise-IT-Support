# Acceptance Criteria — SPEC-PG-002

## Functional Acceptance

- The implementation fulfills the goal: Create database baseline for policies, policy_versions, policy_decisions, approval_requests, approval_decisions, audit, outbox, and processed_events.
- All state transitions follow rules from `07-data-model, 03-state-machine`.
