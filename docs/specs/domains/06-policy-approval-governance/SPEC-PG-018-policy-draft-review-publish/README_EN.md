# SPEC-PG-018 — Policy Draft Review Publish
...
>
> LLD Mapping: `03-state-machine, 05-api-contracts, 11-security`
>
> Document Status: Spec Planning

## 1. Goal

Implement policy draft, review, publish API and reviewer/publisher separation of duties.
