# Acceptance Criteria — SPEC-PG-018

## Functional Acceptance

- The implementation fulfills the goal: Implement policy draft, review, publish API and reviewer/publisher separation of duties.
- All state transitions follow rules from `03-state-machine, 05-api-contracts, 11-security`.
