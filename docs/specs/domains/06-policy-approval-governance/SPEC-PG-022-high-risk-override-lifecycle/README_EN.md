# SPEC-PG-022 — High Risk Override Lifecycle
...
>
> LLD Mapping: `03-state-machine, 04-use-cases, 11-security`
>
> Document Status: Spec Planning

## 1. Goal

Implement override request/approve/deny/use/revoke lifecycle and scope/expiry limits.
