# SPEC-ARO-014 — Pause Workflow Command
...
Implement `Pause Workflow Command` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
