# SPEC-ARO-002 — Agent Runtime Schema Baseline
...
Implement `Agent Runtime Schema Baseline` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
