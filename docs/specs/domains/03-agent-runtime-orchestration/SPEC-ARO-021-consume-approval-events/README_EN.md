# SPEC-ARO-021 — Consume Approval Events
...
Implement `Consume Approval Events` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
