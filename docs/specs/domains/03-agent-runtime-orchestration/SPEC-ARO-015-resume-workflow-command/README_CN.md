# SPEC-ARO-015 — Resume Workflow Command（Resume Workflow Command）
...
>
> LLD 映射：`04-use-cases`, `09-concurrency-and-idempotency`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Resume Workflow Command`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
