# SPEC-ARO-015 — Resume Workflow Command
...
>
> LLD Mapping: `04-use-cases`, `09-concurrency-and-idempotency`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Resume Workflow Command` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
