# SPEC-ARO-027 — Publish Workflow Terminal Events
...
>
> LLD Mapping: `06-event-contracts`, `03-state-machine`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Publish Workflow Terminal Events` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
