# SPEC-ARO-027 — Publish Workflow Terminal Events（发布 Workflow Terminal Events）
...
>
> LLD 映射：`06-event-contracts`, `03-state-machine`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `发布 Workflow Terminal Events`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
