# SPEC-ARO-012 — Checkpoint Around External Waits
...
>
> LLD Mapping: `03-state-machine`, `08-transaction-and-outbox`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Checkpoint Around External Waits` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
