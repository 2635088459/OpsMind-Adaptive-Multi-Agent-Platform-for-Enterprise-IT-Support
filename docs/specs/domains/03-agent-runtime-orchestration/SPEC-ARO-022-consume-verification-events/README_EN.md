# SPEC-ARO-022 — Consume Verification Events
...
Implement `Consume Verification Events` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
