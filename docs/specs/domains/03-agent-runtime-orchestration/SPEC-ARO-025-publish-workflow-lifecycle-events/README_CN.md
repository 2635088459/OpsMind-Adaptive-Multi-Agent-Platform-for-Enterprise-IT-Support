# SPEC-ARO-025 — Publish Workflow Lifecycle Events（发布 Workflow Lifecycle Events）

> 领域：Agent Runtime Orchestration
>
> Phase：07 — Runtime 事件发布
>
> 服务：`agent-runtime-service`
>
> LLD 映射：`06-event-contracts`, `08-transaction-and-outbox`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `发布 Workflow Lifecycle Events`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
