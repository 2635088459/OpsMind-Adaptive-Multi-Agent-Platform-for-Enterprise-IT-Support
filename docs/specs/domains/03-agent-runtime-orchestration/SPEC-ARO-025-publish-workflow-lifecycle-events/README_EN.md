# SPEC-ARO-025 — Publish Workflow Lifecycle Events
...
Implement `Publish Workflow Lifecycle Events` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
