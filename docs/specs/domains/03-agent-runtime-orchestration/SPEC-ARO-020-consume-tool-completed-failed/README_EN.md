# SPEC-ARO-020 — Consume tool.completed and tool.failed
...
Implement `Consume tool.completed and tool.failed` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
