# SPEC-ARO-029 — Expired Lease Task Recovery
...
Implement `Expired Lease Task Recovery` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
