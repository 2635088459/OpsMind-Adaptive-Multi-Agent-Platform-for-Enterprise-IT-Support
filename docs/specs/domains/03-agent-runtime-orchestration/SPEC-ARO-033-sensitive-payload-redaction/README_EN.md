# SPEC-ARO-033 — Sensitive Payload Redaction
...
Implement `Sensitive Payload Redaction` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
