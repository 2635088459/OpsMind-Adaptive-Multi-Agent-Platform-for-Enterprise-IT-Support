# SPEC-ARO-009 — Task Claim Lease Worker API
...
Implement `Task Claim Lease Worker API` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
