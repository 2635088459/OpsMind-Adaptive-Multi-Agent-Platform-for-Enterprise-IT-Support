...
>
> LLD Mapping: `02-business-invariants`, `10-failure-handling`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Stale Generation Worker Result` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
