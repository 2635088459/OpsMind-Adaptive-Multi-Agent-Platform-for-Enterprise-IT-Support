# SPEC-ARO-035 — Event and API Contract Test Harness
...
>
> LLD Mapping: `14-testing-strategy`, `06-event-contracts`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Event and API Contract Test Harness` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
