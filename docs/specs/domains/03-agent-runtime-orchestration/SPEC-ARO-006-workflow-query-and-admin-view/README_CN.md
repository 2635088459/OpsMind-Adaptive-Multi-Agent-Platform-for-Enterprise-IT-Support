# SPEC-ARO-006 — Workflow Query and Admin View（Workflow 查询与运维视图）
...
>
> LLD 映射：`05-api-contracts`, `12-observability`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Workflow 查询与运维视图`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
