# SPEC-ARO-006 — Workflow Query and Admin View
...
>
> LLD Mapping: `05-api-contracts`, `12-observability`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Workflow Query and Admin View` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
