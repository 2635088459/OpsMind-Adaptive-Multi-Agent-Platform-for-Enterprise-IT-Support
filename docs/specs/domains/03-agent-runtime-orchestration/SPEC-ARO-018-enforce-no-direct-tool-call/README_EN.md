# SPEC-ARO-018 — Enforce No Direct Tool Call
...
Implement `Enforce No Direct Tool Call` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
