# SPEC-ARO-017 — Tool Request Aggregate
...
Implement `Tool Request Aggregate` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
