# SPEC-ARO-003 — Runtime Outbox and Idempotency Baseline
...
Implement `Runtime Outbox and Idempotency Baseline` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
