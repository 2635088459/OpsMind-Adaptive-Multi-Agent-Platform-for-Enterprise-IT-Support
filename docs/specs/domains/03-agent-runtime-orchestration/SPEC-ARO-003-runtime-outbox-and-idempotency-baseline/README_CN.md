# SPEC-ARO-003 — Runtime Outbox and Idempotency Baseline（Runtime Outbox 与幂等基线）
...
>
> LLD 映射：`08-transaction-and-outbox`, `09-concurrency-and-idempotency`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Runtime Outbox 与幂等基线`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
