# SPEC-ARO-010 — Task Completion and Join Policy（Task Completion 与 Join Policy）

> 领域：Agent Runtime Orchestration
>
> Phase：02 — Agent Task 编排
>
> 服务：`agent-runtime-service`
>
> LLD 映射：`02-business-invariants`, `08-transaction-and-outbox`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Task Completion 与 Join Policy`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
