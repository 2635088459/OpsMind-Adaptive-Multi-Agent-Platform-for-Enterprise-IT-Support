# SPEC-ARO-028 — Recovery Scanner and Checkpoint Restore（Recovery Scanner 与 Checkpoint Restore）
...
>
> LLD 映射：`10-failure-handling`, `01-domain-model`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Recovery Scanner 与 Checkpoint Restore`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
