# SPEC-ARO-028 — Recovery Scanner and Checkpoint Restore
...
>
> LLD Mapping: `10-failure-handling`, `01-domain-model`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Recovery Scanner and Checkpoint Restore` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
