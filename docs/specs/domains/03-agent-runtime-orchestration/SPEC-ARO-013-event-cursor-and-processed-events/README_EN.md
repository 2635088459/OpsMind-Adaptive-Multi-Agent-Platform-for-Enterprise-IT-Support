# SPEC-ARO-013 — Event Cursor and Processed Events
...
Implement `Event Cursor and Processed Events` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
