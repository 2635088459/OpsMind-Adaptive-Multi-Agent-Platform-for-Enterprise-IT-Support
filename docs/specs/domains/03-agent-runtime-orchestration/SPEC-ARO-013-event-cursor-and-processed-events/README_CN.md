# SPEC-ARO-013 — Event Cursor and Processed Events（Event Cursor 与 Processed Events）

> 领域：Agent Runtime Orchestration
>
> Phase：03 — Checkpoint 与 Cursor
>
> 服务：`agent-runtime-service`
>
> LLD 映射：`01-domain-model`, `09-concurrency-and-idempotency`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Event Cursor 与 Processed Events`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
