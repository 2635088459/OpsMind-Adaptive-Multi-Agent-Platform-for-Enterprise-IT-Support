# SPEC-ARO-004 — Workflow Instance Aggregate
...
Implement `Workflow Instance Aggregate` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
