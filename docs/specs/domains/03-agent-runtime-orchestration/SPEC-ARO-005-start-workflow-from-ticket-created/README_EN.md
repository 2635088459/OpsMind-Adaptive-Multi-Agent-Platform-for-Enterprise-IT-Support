# SPEC-ARO-005 — Start Workflow From ticket.created
...
>
> LLD Mapping: `04-use-cases`, `06-event-contracts`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Start Workflow From ticket.created` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
