# SPEC-ARO-030 — Outbox Replay and Publisher Recovery（Outbox Replay 与 Publisher Recovery）
...
>
> LLD 映射：`08-transaction-and-outbox`, `10-failure-handling`
>
> 文档状态：Spec Planning

## 1. 目标

实现 `Outbox Replay 与 Publisher Recovery`，并保持 Runtime 只拥有 Agent Workflow state，不直接修改 Ticket state。
