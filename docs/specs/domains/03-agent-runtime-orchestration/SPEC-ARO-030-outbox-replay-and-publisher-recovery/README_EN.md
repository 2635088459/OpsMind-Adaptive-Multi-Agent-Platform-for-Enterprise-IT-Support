# SPEC-ARO-030 — Outbox Replay and Publisher Recovery
...
>
> LLD Mapping: `08-transaction-and-outbox`, `10-failure-handling`
>
> Document Status: Spec Planning

## 1. Goal

Implement `Outbox Replay and Publisher Recovery` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
