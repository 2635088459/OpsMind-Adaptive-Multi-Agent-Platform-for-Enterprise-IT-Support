# SPEC-ARO-026 — Publish Agent Task Events
...
Implement `Publish Agent Task Events` while Runtime owns only Agent Workflow state and never directly mutates Ticket state.
