# SPEC-EI-032 — Policy Approval 与 Release Approval Contract
...
>
> LLD 映射：`05-api-contracts, 06-event-contracts`
>
> 文档状态：Spec Planning

## 1. 目标

锁定 06 policy decision、approval lifecycle 和 release approval 对 07 gate/candidate 的契约。
...
- 本 spec 聚焦 `policy approval contract`，不得扩大到相邻 phase 的实现范围。
