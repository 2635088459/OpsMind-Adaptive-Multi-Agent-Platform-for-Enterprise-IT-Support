...
- 能完成目标：实现 07 向 06 发起 release approval request，并消费 approval granted/denied/expired/cancelled。
- 所有状态迁移符合 `05-api-contracts, 06-event-contracts, 11-security` 中定义的规则。
