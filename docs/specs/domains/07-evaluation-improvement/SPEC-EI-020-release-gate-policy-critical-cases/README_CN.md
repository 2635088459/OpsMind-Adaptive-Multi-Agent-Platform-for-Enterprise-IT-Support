# SPEC-EI-020 — Release Gate Policy 与 Critical Cases
...
>
> LLD 映射：`02-business-invariants, 04-use-cases`
>
> 文档状态：Spec Planning

## 1. 目标

实现 release gate policy、critical case enforcement、hard gates 和阈值判断。
...
- 本 spec 聚焦 `release gate policy`，不得扩大到相邻 phase 的实现范围。
