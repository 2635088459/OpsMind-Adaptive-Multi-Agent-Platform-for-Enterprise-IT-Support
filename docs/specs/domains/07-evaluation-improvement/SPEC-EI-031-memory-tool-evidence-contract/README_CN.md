# SPEC-EI-031 — Memory 与 Tool Evidence Contract
...
>
> LLD 映射：`06-event-contracts, 11-security`
>
> 文档状态：Spec Planning

## 1. 目标

锁定 04 Memory retrieval evidence 与 05 Tool result/argument/forbidden call 的评估证据契约。
...
- 本 spec 聚焦 `memory tool evidence contract`，不得扩大到相邻 phase 的实现范围。
