...
- 能完成目标：实现 canary promotion criteria、rollback thresholds、rollback recommendation 和 rollback requested event。
- 所有状态迁移符合 `06-event-contracts, 10-failure-handling` 中定义的规则。
