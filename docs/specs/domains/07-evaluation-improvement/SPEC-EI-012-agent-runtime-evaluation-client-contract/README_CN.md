# SPEC-EI-012 — Agent Runtime Evaluation Client Contract
...
>
> LLD 映射：`05-api-contracts, 14-testing-strategy`
>
> 文档状态：Spec Planning

## 1. 目标

锁定 07 调用 03 Runtime evaluation endpoint 的请求/响应契约和测试 harness。
...
- 本 spec 聚焦 `runtime evaluation contract`，不得扩大到相邻 phase 的实现范围。
