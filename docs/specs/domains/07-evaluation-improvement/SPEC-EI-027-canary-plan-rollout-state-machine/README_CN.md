# SPEC-EI-027 — Canary Plan 与 Rollout State Machine
...
>
> LLD 映射：`03-state-machine, 09-concurrency-and-idempotency`
>
> 文档状态：Spec Planning
...
- 本 spec 聚焦 `canary state machine`，不得扩大到相邻 phase 的实现范围。
