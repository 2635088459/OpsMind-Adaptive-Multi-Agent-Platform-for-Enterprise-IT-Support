# Acceptance Criteria — SPEC-EI-018

## 功能验收

- 能完成目标：实现 judge calibration set、drift detection、grader bundle version 和 drift alert。
- 所有状态迁移符合 `12-observability, 14-testing-strategy` 中定义的规则。
