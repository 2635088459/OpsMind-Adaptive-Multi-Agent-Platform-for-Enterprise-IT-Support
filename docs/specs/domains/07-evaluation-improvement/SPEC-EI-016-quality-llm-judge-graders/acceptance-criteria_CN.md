...
- 能完成目标：实现 explanation quality、evidence grounding、handoff completeness、user instruction clarity 的 LLM Judge。
- 所有状态迁移符合 `01-domain-model, 10-failure-handling` 中定义的规则。
