...
- 能完成目标：定义 test case schema、ground truth、allowed/forbidden tools、approval expectation、verification condition 和 criticality。
- 所有状态迁移符合 `01-domain-model, 07-data-model` 中定义的规则。
