# SPEC-EI-005 — Evaluation Test Case Schema 与 Ground Truth
...
>
> LLD 映射：`01-domain-model, 07-data-model`
>
> 文档状态：Spec Planning

## 1. 目标

定义 test case schema、ground truth、allowed/forbidden tools、approval expectation、verification condition 和 criticality。
...
- 本 spec 聚焦 `test case schema, ground truth`，不得扩大到相邻 phase 的实现范围。
