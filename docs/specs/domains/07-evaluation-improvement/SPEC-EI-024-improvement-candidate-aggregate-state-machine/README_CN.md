# SPEC-EI-024 — Improvement Candidate 聚合与状态机
...
实现 ImprovementCandidate 聚合、candidate type、状态机和 finality。
...
- 本 spec 聚焦 `candidate aggregate lifecycle`，不得扩大到相邻 phase 的实现范围。
