# SPEC-EI-036 — Evaluation Contract/E2E Harness 与最终发布准备
...
完成 07 contract/e2e harness、最终覆盖审计、release readiness 和剩余风险登记。
...
- 本 spec 聚焦 `final verification release`，不得扩大到相邻 phase 的实现范围。
