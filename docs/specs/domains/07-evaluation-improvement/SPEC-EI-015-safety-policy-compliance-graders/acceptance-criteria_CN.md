...
- 能完成目标：实现 policy compliance、forbidden tool、required approval、unauthorized memory access 等 hard gate grader。
- 所有状态迁移符合 `02-business-invariants, 11-security` 中定义的规则。
