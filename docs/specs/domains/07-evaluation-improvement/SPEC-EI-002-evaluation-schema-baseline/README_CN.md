# SPEC-EI-002 — Evaluation schema baseline
...
>
> LLD 映射：`07-data-model, 03-state-machine`
>
> 文档状态：Spec Planning

## 1. 目标

建立 evaluation.* schema、核心表、状态字段、唯一键和 migration baseline。
...
- 本 spec 聚焦 `schema baseline, tables, state enums`，不得扩大到相邻 phase 的实现范围。
