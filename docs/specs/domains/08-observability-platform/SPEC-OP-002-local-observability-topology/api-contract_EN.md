# API and Configuration Contract — SPEC-OP-002
...
Concrete objective: Deliver Compose for all six components with ports, volumes, health checks, and CPU/memory limits.
